          ...
          >
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-xs text-white/60">
                (1,200+ {language === "ar" ? "تقييم" : "reviews"})
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => window.open("https://apps.apple.com/us/app/itrack-gps-tracking-system/id1041798568?l=ar", "_blank")}
              ...
              >
                <FaApple size={24} className="md:w-7 md:h-7" />
                <div className="text-start">
                  <div className="text-[10px] uppercase tracking-wider text-slate-500">
                    Download on the
                  </div>
                  <div className="text-base md:text-lg leading-none font-black">
                    App Store
                  </div>
                </div>
              </motion.button>
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => window.open("https://play.google.com/store/apps/details?id=com.swd.tracker", "_blank")}
              ...
              >
                <FaGooglePlay size={24} className="md:w-7 md:h-7" />
                <div className="text-start">
