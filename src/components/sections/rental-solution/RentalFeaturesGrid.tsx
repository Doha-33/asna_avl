...
interface RentalFeaturesGridProps {
  features: FeatureItem[];
}

const FeatureCard = ({ image, title, desc, icon: Icon }: FeatureItem) => {
...
export const RentalFeaturesGrid = ({ features }: RentalFeaturesGridProps) => (
