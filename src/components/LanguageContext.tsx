...
const translations = {
  ar: {
    ...
    "compare.subtitle": "قارن بين خصائص ومميزات الأجهزة المختلفة",
    "compare.attribute": "الخاصية",
    "compare.network": "الشبكة",
    "compare.sound": "الصوت",
    "compare.interference": "التشويش",
    "compare.power": "الطاقة",
    "compare.installation": "التركيب",
    "compare.price": "السعر",
    "compare.brand": "العلامة التجارية",
  ...
  en: {
    ...
    "compare.subtitle": "Compare features and specifications of different devices",
    "compare.attribute": "Attribute",
    "compare.network": "Network",
    "compare.sound": "Sound",
    "compare.interference": "Interference",
    "compare.power": "Power",
    "compare.installation": "Installation",
    "compare.price": "Price",
    "compare.brand": "Brand",
